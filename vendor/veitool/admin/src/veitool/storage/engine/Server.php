...
abstract class Server
{
    ...
    public function setUploadFile($name)
    {
        ...
        // 文件信息
        $this->fileInfo = ['name'=>$this->file->getFilename(),'oname'=> $this->file->getUploadName(),'size'=>$this->file->getSize(),'type' => $this->file->getUploadMimeType(),'ext' => $this->file->getUploadExtension()];
    }
