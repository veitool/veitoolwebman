...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='管理用户';

-- ----------------------------
-- Records of vt_system_manager
-- ----------------------------
INSERT INTO `vt_system_manager` VALUES ('1', 'admin', '7e618aaa25356b3049e608a9a29790b1', 'Rt4UBXRZ', '1', '1', '1', '超管员', '超管', '1', '', '15900000001', '26843818@qq.com', '20', '广州', '127.0.0.1', '4', '1749530838', '1', '', '', '1749630366', '0', '0');
...
CREATE TABLE `vt_system_menus` (
  ...
  `del_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '删除时间',
  PRIMARY KEY (`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限';
...
CREATE TABLE `vt_system_roles` (
  ...
  `del_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '删除时间',
  PRIMARY KEY (`roleid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='管理角色';

-- ----------------------------
-- Records of vt_system_roles
-- ----------------------------
INSERT INTO `vt_system_roles` VALUES ('1', '超级管理员', '', '', '1', '1', '', '', '1552297670', '0', '0');
INSERT INTO `vt_system_roles` VALUES ('2', '系统管理员', '', '', '2', '1', '', '', '1552297670', '0', '0');
...
INSERT INTO `vt_system_setting` VALUES ('3', 'sys_title', '面板名称', 'system', 'text', '后台管理', '', '后台管理面板显示的名称', '', '0', '2', '', '1', '', '', '1475240646', '0', '0');
INSERT INTO `vt_system_setting` VALUES ('4', 'site_title', '网站名称', 'system', 'text', 'VEITOOL框架', '', '网站标题名称', '', '0', '2', '', '1', '', '', '1475240646', '0', '0');
